...
print("Loan Origination Validation data AUC summary: \n") 
...
mp_auc_list$glm <- h2o.auc(mp_perf_glm)

print("Marketplace Loan Validation data AUC summary: \n") 
