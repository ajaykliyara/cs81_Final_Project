...
get_rf_grid <- function(split_list, 
  ...
  sortedGrid <- h2o.getGrid(rf_grid_name[1], sort_by="auc")
  return(sortedGrid)
}
```
...
get_gbm_grid <- function(split_list, 
  ...
  sortedGrid <- h2o.getGrid(gbm_grid_name[1], sort_by="auc")
...
get_dl_grid <- function(split_list, 
  ...
  sortedGrid <- h2o.getGrid(dl_grid_name[1], sort_by="auc")
...
dl_grid <- get_dl_grid(split_list, nfolds)
