...
note_trading_col <- c("last_fico_range_high", "last_fico_range_low",
                      "last_pymnt_amnt", "last_credit_pull_d", "total_pymnt", "total_rec_prncp", 
                      "total_rec_int", "total_rec_late_fee")
...
models <- list(glm_model, h2o.getModel(rf_grid@model_ids[[1]]), h2o.getModel(rf_grid@model_ids[[2]]), 
               h2o.getModel(gbm_grid@model_ids[[1]]), h2o.getModel(gbm_grid@model_ids[[2]]))
