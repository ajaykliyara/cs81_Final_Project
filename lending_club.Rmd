...
h2o.rm("rf_grid")
best_model <- get_rf_grid(data, factor_cols, 4)
...
best_predictors <- best_predictors[1:16]
...
factor_cols <- c("is_bad", "zip_code", "addr_state", "grade", "sub_grade")
```
...
## Random Forest Model
h2o.rm("rf_model")
rf_model <- get_rf_grid(data, factor_cols, 25)
